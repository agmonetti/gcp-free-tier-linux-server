...
El objetivo era desplegar un entorno de servidor# ☁️ Infraestructura GCP Free Tier
...
*Este repositorio documenta la infraestructura. El código fuente de los servicios se mantiene en repositorios privados.*
 propio en la nube para alojar proyectos personales, con una restricción estricta: **mantenerse 100% dentro de la Capa Gratuita (Free Tier) de Google Cloud Platform.**
